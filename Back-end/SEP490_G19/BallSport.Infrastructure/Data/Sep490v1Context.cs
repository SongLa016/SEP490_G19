...
public partial class Sep490v1Context : DbContext
{
    public Sep490v1Context()
    {
    }

    public Sep490v1Context(DbContextOptions<Sep490v1Context> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Booking>(entity =>
        {
            ...
            entity.HasIndex(e => e.MatchRequestId, "IX_Bookings_MatchRequestID");
        ...
        modelBuilder.Entity<BookingCancellation>(entity =>
        {
            ...
            entity.HasIndex(e => e.BookingId, "IX_BookingCancellations_BookingID");

            entity.HasIndex(e => e.RequestId, "IX_BookingCancellations_RequestID");

            entity.HasIndex(e => e.VerifiedBy, "IX_BookingCancellations_VerifiedBy");
        ...
        modelBuilder.Entity<BookingCancellationRequest>(entity =>
        {
            ...
            entity.HasIndex(e => e.BookingId, "IX_BookingCancellationRequests_BookingID");

            entity.HasIndex(e => e.RequestedByUserId, "IX_BookingCancellationRequests_RequestedByUserID");

            entity.HasIndex(e => e.ReversedByUserId, "IX_BookingCancellationRequests_ReversedByUserID");
        ...
        modelBuilder.Entity<CancellationPolicy>(entity =>
        {
            ...
            entity.HasIndex(e => e.FieldId, "IX_CancellationPolicies_FieldID");
        ...
        modelBuilder.Entity<DepositPolicy>(entity =>
        {
            ...
            entity.HasIndex(e => e.FieldId, "IX_DepositPolicies_FieldID");
        ...
        modelBuilder.Entity<Field>(entity =>
        {
            ...
            entity.HasIndex(e => e.BankAccountId, "IX_Fields_BankAccountID");

            entity.HasIndex(e => e.ComplexId, "IX_Fields_ComplexID");

            entity.HasIndex(e => e.TypeId, "IX_Fields_TypeID");
        ...
        modelBuilder.Entity<FieldComplex>(entity =>
        {
            ...
            entity.HasIndex(e => e.OwnerId, "IX_FieldComplexes_OwnerID");
        ...
        modelBuilder.Entity<FieldPrice>(entity =>
        {
            ...
            entity.HasIndex(e => e.SlotId, "IX_FieldPrices_SlotID");

            entity.HasIndex(e => new { e.FieldId, e.SlotId }, "UQ__FieldPri__2817DB823439E8DC")
                .IsUnique()
        ...
        modelBuilder.Entity<FieldSchedule>(entity =>
        {
            ...
            entity.HasIndex(e => e.SlotId, "IX_FieldSchedules_SlotID");

            entity.HasIndex(e => new { e.FieldId, e.Date, e.SlotId }, "UQ__FieldSch__F1CF6ABC02AE2AE5")
                .IsUnique()
                .HasFilter("([FieldID] IS NOT NULL AND [SlotID] IS NOT NULL)");
        ...
        modelBuilder.Entity<MatchParticipant>(entity =>
        {
            ...
            entity.HasIndex(e => e.MatchRequestId, "IX_MatchParticipants_MatchRequestID");
        ...
        modelBuilder.Entity<MatchRequest>(entity =>
        {
            ...
            entity.HasIndex(e => e.BookingId, "IX_MatchRequests_BookingID");

            entity.HasIndex(e => e.CreatedBy, "IX_MatchRequests_CreatedBy");
        ...
        modelBuilder.Entity<OwnerBankAccount>(entity =>
        {
            ...
            entity.HasIndex(e => e.OwnerId, "IX_OwnerBankAccounts_OwnerID");
        ...
        modelBuilder.Entity<PlayerBankAccount>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserId, "IX_PlayerBankAccounts_UserID");
        ...
        modelBuilder.Entity<PlayerMatchHistory>(entity =>
        {
            ...
            entity.HasIndex(e => e.MatchRequestId, "IX_PlayerMatchHistory_MatchRequestID");

            entity.HasIndex(e => e.UserId, "IX_PlayerMatchHistory_UserID");
        ...
        modelBuilder.Entity<Post>(entity =>
        {
            ...
            entity.HasIndex(e => e.FieldId, "IX_Posts_FieldID");
        ...
        modelBuilder.Entity<PostLike>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserId, "IX_PostLikes_UserID");
        ...
        modelBuilder.Entity<Report>(entity =>
        {
            ...
            entity.HasIndex(e => e.HandledBy, "IX_Reports_HandledBy");
        ...
        modelBuilder.Entity<SystemNotification>(entity =>
        {
            ...
            entity.HasIndex(e => e.SentBy, "IX_SystemNotifications_SentBy");
        ...
        modelBuilder.Entity<Team>(entity =>
        {
            ...
            entity.HasIndex(e => e.CreatedBy, "IX_Teams_CreatedBy");
        ...
        modelBuilder.Entity<TeamJoinRequest>(entity =>
        {
            ...
            entity.HasIndex(e => e.RespondedBy, "IX_TeamJoinRequests_RespondedBy");

            entity.HasIndex(e => e.TeamId, "IX_TeamJoinRequests_TeamID");

            entity.HasIndex(e => e.UserId, "IX_TeamJoinRequests_UserID");
        ...
        modelBuilder.Entity<TimeSlot>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.FieldId, e.StartTime, e.EndTime }, "UQ_TimeSlot_FieldTime").IsUnique();
        ...
        modelBuilder.Entity<UserProfile>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserId, "UQ__UserProf__1788CCAD01035ECC")
                .IsUnique()
        ...
        modelBuilder.Entity<UserRole>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.UserId, e.RoleId }, "UQ__UserRole__AF27604EA2C5F7A0")
                .IsUnique()
        ...
        modelBuilder.Entity<ViolationReport>(entity =>
        {
            ...
            entity.HasIndex(e => e.ReportedUserId, "IX_ViolationReports_ReportedUserID");

            entity.HasIndex(e => e.ReporterId, "IX_ViolationReports_ReporterID");
