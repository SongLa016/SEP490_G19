...
export async function fetchOwnerDailyRevenue(params = {}) {
  try {
    ...
    console.error("[OwnerStatisticsService] fetchOwnerDailyRevenue failed:", error);
...
export async function fetchOwnerFieldPerformance(params = {}) {
  try {
    ...
    console.error("[OwnerStatisticsService] fetchOwnerFieldPerformance failed:", error);
    return { ok: false, reason };
  }
}
...
export async function fetchOwnerRecentBookings(params = {}) {
  try {
    ...
    console.error("[OwnerStatisticsService] fetchOwnerRecentBookings failed:", error);
    return { ok: false, reason };
  }
}
...
export async function fetchOwnerTotalRevenue(params = {}) {
  try {
    ...
    const reason = extractErrorMessage(
      error,
      "Không thể lấy tổng doanh thu."
    );
    console.error("[OwnerStatisticsService] fetchOwnerTotalRevenue failed:", error);
    return { ok: false, reason };
  }
}
...
export async function fetchOwnerTotalBookings(params = {}) {
  try {
    ...
    const reason = extractErrorMessage(
      error,
      "Không thể lấy tổng số booking."
    );
    console.error("[OwnerStatisticsService] fetchOwnerTotalBookings failed:", error);
    return { ok: false, reason };
  }
}
