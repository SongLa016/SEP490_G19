...
import { listMatchRequests, joinMatchRequest } from "../../../../../shared/index";
import { getBookingById } from "../../../../../shared/index";
import Swal from "sweetalert2";

// MatchRequestCard Component
function MatchRequestCard({ mr, index, highlightPostId, highlightRef, user, filterLevel, filterLocation, filterDate, setMatchRequests }) {
     const cardRef = useRef(null);
     const isInView = useInView(cardRef, { once: true, margin: "-50px" });
     const bookingInfo = getBookingById(mr.bookingId);
                              ...
                              <div className="flex items-center gap-2 ml-4">
                                   {user?.id === mr.ownerId ? (
                                        ...
                                        <motion.div
                                             ...
                                             whileTap={{ scale: 0.95 }}
                                        >
                                             <Button onClick={handleJoin} className="bg-teal-500 hover:bg-teal-600 text-white flex items-center gap-2">
