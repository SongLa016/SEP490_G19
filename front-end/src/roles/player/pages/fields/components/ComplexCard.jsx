          ...
          <FadeIn key={complex.complexId} delay={index * 50}>
               ...
               >
                    ...
                    <div className="p-3 flex-1 flex flex-col">
                         <h3 className="text-lg font-semibold text-teal-800 mb-1 flex items-center">
                              <StadiumIcon className="w-5 h-5 mr-2 text-teal-500" />
                              {complex.name}
                         </h3>
                         <div className="flex bg-teal-50 border border-teal-100 px-2 gap-1 rounded-full w-fit items-center text-teal-700 mb-2">
                              <MapPin className="w-4 h-4" />
                              <span className="text-sm line-clamp-1">{complex.address}</span>
                         </div>
