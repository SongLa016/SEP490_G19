                         ...
                         <Table className="w-full border-collapse">
                                             ...
                                             >
                                                  <div className="flex flex-col items-center gap-1">
                                                       ...
                                                       {(selectedDate.getDay() === 0 || selectedDate.getDay() === 6) && !isToday(selectedDate) && (
                                                            <p className="bg-orange-50 text-orange-600 border text-[10px] font-semibold py-0.5 px-2 rounded-full">
                                                                 Cuối tuần
                                                            </p>
                                                       )}
                                                  </div>
                              ...
                              <TableBody>
                                   {timeSlots.length === 0 ? (
                                        ...
                                        timeSlots
                                             // Filter slots by selected field if needed
                                             .filter(slot => {
                                                  if (selectedFieldForSchedule === 'all') {
                                                       return true; // Show all slots
                                                  }
                                                  const slotFieldId = slot.fieldId ?? slot.FieldId;
                                                  return Number(slotFieldId) === Number(selectedFieldForSchedule);
                                             })
                                             .map((slot, slotIndex) => {
                                                                      ...
                                                                      <div className="space-y-2">
                                                                           {visibleSchedules.map((schedule, idx) => {
                                                                                ...
                                                                                return (
                                                                                     <div
                                                                                          key={idx}
                                                                                          className={`${fieldColor} text-white p-2 rounded-2xl w-fit text-sm font-medium cursor-pointer hover:opacity-90 hover:shadow-lg transition-all shadow-md`}
                                                                                          onClick={(e) => {
                                                                                               e.stopPropagation();
                                                                                               // Hiển thị thông tin chi tiết cho tất cả các trạng thái
                                                                                               ...
                                                                                               Swal.fire({
                                                                                                    ...
                                                                                                    <div class="text-left space-y-2">
                                                                                                         ...
                                                                                                         ` : ''}
                                                                                                         ${available ? `
                                                                                                         <div class="bg-blue-50 p-1 rounded-xl border border-blue-200">
                                                                                                              <p class="text-sm text-gray-600 text-center">
                                                                                                                   <strong class="text-blue-800">💡 Lịch trình này đang trống và sẵn sàng cho đặt sân</strong>
                                                                                                              </p>
                                                                                                         </div>
                                                                                                         ` : ''}
                                                                                                         ${maintenance ? `
                                                                                                         <div class="bg-orange-50 p-3 rounded-lg border border-orange-200">
                                                                                                              <p class="text-sm text-gray-600 text-center">
                                                                                                                   <strong class="text-orange-800">⚠️ Sân đang trong thời gian bảo trì</strong>
                                                                                                              </p>
                                                                                                         </div>
                                                                                                         ` : ''}
                                                                                                    </div>
                                                                                     ...
                                                                                     >
                                                                                          ...
                                                                                          <div className="text-xs opacity-90 flex items-center gap-1.5">
                                                                                               <span>Giờ: {formatTime(slot.StartTime || slot.startTime)} - {formatTime(slot.EndTime || slot.endTime)}</span>
                                                                                               {booked && (
