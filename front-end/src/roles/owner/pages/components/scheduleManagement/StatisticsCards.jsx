...
export default function StatisticsCards({ statistics = {} }) {
     ...
     const totalSlots = formatNumber(statistics.totalSlots);
     const bookedSlots = formatNumber(statistics.bookedSlots);
     const availableSlots = formatNumber(statistics.availableSlots);
     const occupancyRate = formatPercent(statistics.occupancyRate);
               ...
               <Card className="p-4 bg-gradient-to-br from-green-50 to-green-100 border-green-200">
                    <div className="flex items-center justify-between">
                         <div>
                              ...
                              <p className="text-2xl font-bold text-green-900">{bookedSlots}</p>
                         </div>
